...
open class HeisenbergBoard<Value> where Value: Equatable{
    ...
    public func drawBoard() -> UIView {
        ...
        if boardItem is HeisenbergLinearStructure<Value>{
        ...
        }else if boardItem is HeisenbergDirectionalStructure<Value>{
            ...
            for item in boardy.getEdges() {
                ...
                if item.1 == .next {
                    ...
                    lineView = DirectionalLineView(frame: CGRect(x: item.2.startPoint.x + itemSize,
                                        ...
                                        lineColor: item.4,
                                        lineBond: LineView.BondType(rawValue: item.3.rawValue)!,
                                        structure: item.1,
